    ...
    return (
        <div className='d-flex w-100 vh-100 justify-content-center align-items-center bg-light'>
            <div className='w-50 border bg-white shadow px-5 pt-3 pb-5 rounded'>
                ...
                <div className='mb-2'>
                        <label htmlFor="name">Reg No:</label>
                        <input type="text" name='regno' className='form-control' placeholder='Enter Register Number' onChange={e => setValues({...values, regno: e.target.value})}/>
                    </div>
                    <div className='mb-2'>
