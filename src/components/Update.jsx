    ...
    return (
        ...
        <div className='w-50 border bg-white shadow px-5 pt-3 pb-5 rounded'>
            ...
            <div className='mb-2'>
                    ...
                    <input type="text" name='regno' className='form-control' placeholder='Enter Register Number' value={values.regno}  onChange={e => setValues({...values, regno: e.target.value})}/>
                </div>
                <div className='mb-2'>
